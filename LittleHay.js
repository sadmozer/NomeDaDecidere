...
LittleHay.prototype.getState = function() {
    return this.State;
}

LittleHay.prototype.setState = function(State) {
    this.State = State;
}

LittleHay.prototype.Update = function (InputController, GameObjectList, player, backShadows) {
...
LittleHay.prototype.Render = function() {
    this.State;
    var anim = null;
    switch(this.State) {
        case "In volo":
...
LittleHay.prototype.CastShadow = function() {
    context.save();
    context.beginPath();
